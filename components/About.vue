<template>
  <section class="flex flex-col gap-y-3">
    ...
    <p class="font-mono text-sm text-gray-500 text-pretty dark:text-gray-400">
      ...
      ability to craft stunning products. Currently, I work mostly with
      TypeScript, TailwindCSS, Vue, Nuxt, Node.js, and Laravel. For over 7
      years, I have been immersed in remote collaborations with companies around
      the world.
    </p>
  </section>
</template>
